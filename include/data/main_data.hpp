...
#define ITEM_TABLE(NAME) NAME "(id INTEGER, group_id INTEGER, global_name TEXT, cubic DOUBLE, weight DOUBLE, brute_value INTEGER)"
#define VOLUME_TABLE(NAME) NAME "(id INTEGER, group_id INTEGER, item_id INTEGER, volume_batch INTEGER, weight DOUBLE, volume_m3 DOUBLE, value INTEGER)"
